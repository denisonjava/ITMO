...
WHERE range < 5000;
/*==============================================================*/
SELECT book_ref, passenger_id, passenger_name --исправлено
...
/*==============================================================*/
SELECT flight_no, scheduled_departure, scheduled_arrival, departure_airport, arrival_airport --добавлена запятая
FROM bookings.flights
WHERE departure_airport = 'DME'
...
FROM bookings.flights
WHERE departure_airport = 'DME' 
	AND actual_departure IS NULL; --исправлено 
/*==============================================================*/
SELECT
	flight_no,
	scheduled_departure,
...
SELECT
	COUNT(*)
FROM bookings.ticket_flights
WHERE fare_conditions = 'Economy'; --исправлены кавычки
/*==============================================================*/
SELECT
	COUNT(*)
FROM bookings.flights
...
SELECT
	...
	count(actual_arrival) 
FROM bookings.flights;
GROUP BY departure_airport; --исправлено
/*==============================================================*/
SELECT
	departure_airport,
	count(actual_arrival)
